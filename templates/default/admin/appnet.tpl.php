    ...
    <div class="col-md-10 col-md-offset-1">
        <form action="/admin/appnet/" class="form-horizontal" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="name" placeholder="App Key" name="appId" value="<?=htmlspecialchars(\Idno\Core\site()->config()->appnet['appId'])?>" >
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="name">Client Secret</label>
                <div class="controls">
                    <input type="text" id="name" placeholder="Secret Key" name="secret" value="<?=htmlspecialchars(\Idno\Core\site()->config()->appnet['secret'])?>" >
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
